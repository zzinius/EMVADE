...
Position position_B = {7,7};
Position position_C = {-3,7};
...
void posNum(int &p) {
  if(x>=0 && x<=4 && y>=6 && y<=8){
                ...
                else if(x>=4 && x<=8 && y>=6 && y<=8){
                  p=2;
                }
                else if(x>=6 && x<=8 && y>=2 && y<=6){
                  p=3;
                }
                else if(x>=2.5 && x<=8 && y>=0 && y<=2){
                  p=4;
                }
                else if(x>=-3 && x<=2.5 && y>=0 && y<=2){
                  p=5;
                }
                else if(x>=-3 && x<=0 && y>=2 && y<=7){
                  p=6;
                }
                else if(x>=1 && x<=4.5 && y>=2.5 && y<=5.5){
                  p=7;
                }
}
